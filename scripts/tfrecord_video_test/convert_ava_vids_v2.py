...
#output_dir = "/data/ulutan/AVA/tfrecords/train_tfrecords_v2/"
...
#output_dir = "/data/ulutan/AVA/tfrecords/val_tfrecords_v2/"
output_dir = "/data/ulutan/AVA/tfrecords/test_tfrecords_v2/"
...
def generate_tfrecord(movie):
    ...
    for segment in segments:
        ...
        with tf.python_io.TFRecordWriter(output_file) as writer:
             ...
             dim = 400
             f_timesteps, f_H, f_W, f_C = [32, dim, dim, 3]
